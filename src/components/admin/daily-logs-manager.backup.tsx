            ...
            <thead className="bg-muted/50">
              <tr>
                ...
                <th className="text-left">
                  <div className="flex items-center gap-1 cursor-pointer" onClick={() => toggleSort('employee')}>
                    Employee {sortBy === 'employee' && (sortDir === 'asc' ? '↑' : '↓')}
                  </div>
                </th>
                <th className="text-right">
                  <div className="flex items-center justify-end gap-1 cursor-pointer" onClick={() => toggleSort('connectionsSent')}>
                    Conn. {sortBy === 'connectionsSent' && (sortDir === 'asc' ? '↑' : '↓')}
                  </div>
                </th>
                <th className="text-right">
                  <div className="flex items-center justify-end gap-1 cursor-pointer" onClick={() => toggleSort('accepted')}>
                    Acc. {sortBy === 'accepted' && (sortDir === 'asc' ? '↑' : '↓')}
                  </div>
                </th>
                <th className="text-right">
                  <div className="flex items-center justify-end gap-1 cursor-pointer" onClick={() => toggleSort('messagesSent')}>
                    Msgs {sortBy === 'messagesSent' && (sortDir === 'asc' ? '↑' : '↓')}
                  </div>
                </th>
                <th className="text-right">
                  <div className="flex items-center justify-end gap-1 cursor-pointer" onClick={() => toggleSort('replies')}>
                    Rep. {sortBy === 'replies' && (sortDir === 'asc' ? '↑' : '↓')}
                  </div>
                </th>
                <th className="text-right">
                  <div className="flex items-center justify-end gap-1 cursor-pointer" onClick={() => toggleSort('interestedLeads')}>
                    Int. {sortBy === 'interestedLeads' && (sortDir === 'asc' ? '↑' : '↓')}
                  </div>
        {/* Pagination controls */}
